...
import addmaincategory from "./parts/addMainCategories.vue";
...
<template>
    <Layout>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div
                                                ...
                                                <b-table table-class="table table-centered datatable table-card-list"
                                                    ...
                                                    <template v-slot:cell(display_image)="data">
                                                        <div class="m-auto">
                                                            <img :src="data.item.display_image" :height="30" />
                                                        </div>
                                                    </template>
                                                    <template v-slot:cell(categories)="data">
                                                        <div class="m-auto overflow-auto">
                                                            <li v-for="cat in data.item.categories" :key="cat.id"
                                                        ...
                                                        <ul class="list-inline mb-0">
                                                            ...
                                                            <li class="list-inline-item">
                                                                <a href="javascript:void(0);" class="px-2 text-danger"
                                                                    v-b-tooltip.hover title="Delete" @click="deleterec(
                                                                            data.index,
                                                                            data.item.id,
                                                                            data.item.name,
                                                                        )
        ...
        <b-modal id="modal-Add" :title="modaltitle" hide-footer size="xl" centered>
            <addmaincategory :name="name" :id="myid" :myindex="myindex" :display_image="display_image" :editmode="editmode"
                :modaltitle="modaltitle" :orderData="orderData">
            </addmaincategory>
        </b-modal>
    </Layout>
</template>
