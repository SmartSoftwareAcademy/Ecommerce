...
import addcategory from "./parts/addCategories.vue";
...
<template>
    <Layout>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div
                                                ...
                                                <b-table table-class="table table-centered datatable table-card-list"
                                                    ...
                                                    <template v-slot:cell(Subcategories)="data">
                                                        <div class="m-auto overflow-auto">
                                                            <li v-for="subcat in data.item.Subcategories" :key="subcat.id"
        ...
        <b-modal id="modal-Add" :title="modaltitle" hide-footer size="xl" centered>
            <addcategory :name="name" :id="myid" :myindex="myindex" :display_image="display_image" :editmode="editmode"
