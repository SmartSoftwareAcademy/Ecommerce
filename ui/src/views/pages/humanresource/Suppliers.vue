...
<template>
    <Layout>
                                            ...
                                            <div
                                                ...
                                                <b-table table-class="table table-centered datatable table-card-list"
                                                    ...
                                                    <template v-slot:cell(addresses)="data">
                                                        <p v-for="addr in data.item.address" class="d-inline"
                                                            :key="addr.id">
                                                            {{ addr.city }}-{{ addr.box }},</p>
                                                    </template>
        ...
        <b-modal id="modal-Add" :title="modaltitle" hide-footer size="xl" centered>
            <addSupplier :name="name" :id="myid" :address="address" :myindex="myindex" :editmode="editmode"
