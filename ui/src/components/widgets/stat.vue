                ...
                <div class="card-body">
                    ...
                    <p class="text-muted mt-3 mb-0">
                        <span class="text-danger me-1"
                            :class="{ 'text-success': Number(order_changes[orders - 1]) >= Number(order_changes[orders - 2]) }">
                            <i class="mdi mdi-arrow-down-bold me-1"
                                :class="{ 'mdi mdi-arrow-up-bold': Number(order_changes[orders - 1]) >= Number(order_changes[orders - 2]) }"></i>{{ ((Number(order_changes[orders - 1]) / Number(orders)) * 100).toFixed(2) }}%
                        </span>
                        since last week
                    </p>
                </div>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted mt-3 mb-0">
                        <span class="text-danger me-1"
                            :class="{ 'text-success': Number(customer_changes[customers - 1]) >= Number(customer_changes[customers - 2]) }">
                            <i class="mdi mdi-arrow-down-bold me-1"
                                :class="{ 'mdi mdi-arrow-up-bold': Number(customer_changes[customers - 1]) >= Number(customer_changes[customers - 2]) }"></i>{{ ((Number(customer_changes[customers - 1]) / Number(customers)) * 100).toFixed(2) }}%
                        </span>
                        since last week
                    </p>
                </div>
