...
export default {
  ...
  methods: {
    ...
    deleterec(index, myid, order_id) {
      this.myid = myid;
      this.order_id = order_id;
      Swal.fire({
        title: "Are you sure, you want to delete? " + order_id,
      ...
      >
        ...
        <template v-slot:cell(payment_status)="data">
          <div
            ...
            :class="{ 'bg-soft-warning': data.item.payment_status === 'Pending' }"
          >
