...
<template>
    <Layout>
                                            ...
                                            <div
                                                ...
                                                <b-table table-class="table table-centered datatable table-card-list"
                                                    ...
                                                    <template v-slot:cell(addresses)="data">
                                                        <p v-for="addr in data.item.addresses" class="d-inline"
                                                            :key="addr.id">
                                                            {{ addr.city }},</p>
                                                    </template>
                                                    <template v-slot:cell(first_name)="data">
                                                        <div class="m-auto overflow-auto">
                                                            <li class="d-inline overflow-auto">
                                                                {{ data.item.user.first_name }}</li>
                                                        </div>
                                                    </template>
                                                    <template v-slot:cell(last_name)="data">
                                                        <div class="m-auto overflow-auto">
                                                            <li class="d-inline overflow-auto">
                                                                {{ data.item.user.last_name }}</li>
                                                        </div>
                                                    </template>
                                                    <template v-slot:cell(email)="data">
                                                        <div class="m-auto overflow-auto">
                                                            <li class="d-inline overflow-auto">
                                                                {{ data.item.user.email }}</li>
                                                        </div>
                                                    </template>
                                                    <template v-slot:cell(phone)="data">
                                                        <div class="m-auto overflow-auto">
                                                            <li class="d-inline overflow-auto">
                                                                {{ data.item.user.phone }}</li>
                                                        </div>
                                                    </template>
        ...
        <b-modal id="modal-Add" :title="modaltitle" hide-footer size="xl" centered>
            <addCustomer :name="name" :id="myid" :address="address" :myindex="myindex" :editmode="editmode"
