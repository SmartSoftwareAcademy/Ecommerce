...
import addsubcategory from "./parts/addSubCategories..vue";
...
<template>
    <Layout>
        ...
        <b-modal id="modal-Add" :title="modaltitle" hide-footer size="xl" centered>
            <addsubcategory :name="name" :id="myid" :myindex="myindex" :display_image="display_image" :editmode="editmode"
